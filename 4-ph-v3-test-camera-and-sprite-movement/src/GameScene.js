...
export default class GameScene extends Phaser.Scene {
    ...
    create(){
        ...
        */
        ...
        this.physics.world.events.on('COLLIDE_EVENT', (event)=>{console.log('Collision Detected')});
    ...
    update(){
        ...
        this.physics.world.collide(this.adam, 'rocks', function(){ console.log('hitting rocks!'); });
        this.physics.world.collide(this.adam, this.rocks, function(){ console.log('hitting rocks!'); });
        this.physics.world.collide(this.adam, this.grass, function(){ console.log('hitting grass!'); });
